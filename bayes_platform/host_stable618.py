...
TRIGGER_TOPIC   = "LC/R8/133-1-1/PC06/bay/python"
SETUP_TOPIC     = "LC/R8/133-1-1/PC06/bay/setup"
TAGMAP_TOPIC    = "LC/R8/133-1-1/PC06/bay/tagmap"
INPUT_TOPIC     = "LC/R8/133-1-1/PC06/bay/input"
RESULT_TOPIC    = "LC/R8/133-1-1/PC06/bay/result"
STATUS_TOPIC    = "LC/R8/133-1-1/PC06/bay/status"
PLATFORM_STATUS = "LC/R8/133-1-1/PC06/bay/platform_status"
DATA_IN_TOPIC       = "LC/R8/133-1-1/PC06/bay/data_in"
DATA_OUT_TOPIC = "LC/R8/133-1-1/PC06/bay/data" 
    ...
    def handle_message(self, topic, payload):
        try:
            ...
            if topic == TRIGGER_TOPIC:
                ...
                if matched_idx is not None and not changes:
                    self.mqtt_handler.publish("status", {"status": "duplicate_trial", "trial_index": matched_idx})
    ...
    def status_loop(self):
        while True:
            status = {
                ...
                "last_suggestion": self.last_suggestion or None,
